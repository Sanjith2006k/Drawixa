    ...
    <div className="relative min-h-screen bg-background flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-textSecondary">Join Drawixa and start creating</p>
        </div>
        ...
        <GlassCard className="p-8">
          ...
          <p className="text-center text-textSecondary text-sm mt-6">
            Already have an account? <Link to="/login" className="text-primary hover:text-hover transition-colors font-medium">Log in</Link>
          </p>
        </GlassCard>
      </div>
    </div>
